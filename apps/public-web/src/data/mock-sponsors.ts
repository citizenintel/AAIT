...
export const PLACEMENT_LABELS: Record<PlacementId, string> = {
  'LEFT_RAIL_HALF_PAGE': 'Left Rail — Large Vertical Sponsor',
  'BOTTOM_PRIMARY_BILLBOARD': 'Bottom Bar — Primary Billboard',
  'BOTTOM_SECONDARY_BILLBOARD': 'Bottom Bar — Secondary Billboard',
  'RIGHT_RAIL_HALF_PAGE': 'Right Rail — Large Vertical Sponsor',
};
...
export const MOCK_ASSIGNMENTS: Assignment[] = [
  {
    ...
    placementId: 'LEFT_RAIL_HALF_PAGE',
    status: 'ACTIVE',
    startAt: rollingDate(20),
    endAt: rollingExpiry(10),
    priority: 10,
  ...
  {
    id: 'assign-veldbroadband-primary',
    campaignId: 'campaign-veldbroadband-main',
    placementId: 'BOTTOM_PRIMARY_BILLBOARD',
    status: 'ACTIVE',
    startAt: rollingDate(5),
    endAt: rollingExpiry(25),
    priority: 5,
  ...
  {
    id: 'assign-agrishield-secondary',
    campaignId: 'campaign-agrishield-main',
    placementId: 'BOTTOM_SECONDARY_BILLBOARD',
    status: 'ACTIVE',
    startAt: rollingDate(2),
    endAt: rollingExpiry(5),
    priority: 5,
  ...
  {
    id: 'assign-cybervault-rightrail',
    campaignId: 'campaign-cybervault-main',
    placementId: 'RIGHT_RAIL_HALF_PAGE',
    status: 'ACTIVE',
    startAt: rollingDate(1),
    endAt: rollingExpiry(6),
    priority: 5,
...
export const MOCK_SPONSOR_ADS: SponsorAd[] = [
  {
    ...
    websiteUrl: 'https://farmwatch-demo.co.za',
    imageUrl: TEST_CREATIVE_URIS['LEFT_RAIL_HALF_PAGE'],
    bgColor: '#1a2332',
    textColor: '#e2e8f0',
    accentColor: '#ed8936',
    icon: 'shield',
  ...
  },
  {
    id: 'sp-006',
    name: 'Veld Broadband',
    slot: 'BOTTOM_PRIMARY_BILLBOARD',
    enabled: true,
    size: 'standard',
    tagline: 'Rural Connectivity — No Dead Zones',
    websiteUrl: 'https://veldbroadband-demo.co.za',
    imageUrl: TEST_CREATIVE_URIS['BOTTOM_PRIMARY_BILLBOARD'],
    bgColor: '#1a2332',
    textColor: '#e2e8f0',
    accentColor: '#9f7aea',
    icon: 'web',
  ...
  },
  {
    id: 'sp-003',
    name: 'AgriShield Insurance',
    slot: 'BOTTOM_SECONDARY_BILLBOARD',
    enabled: true,
    size: 'standard',
    tagline: 'Protecting South African Farmers Since 1998',
    websiteUrl: 'https://agrishield-demo.co.za',
    imageUrl: TEST_CREATIVE_URIS['BOTTOM_SECONDARY_BILLBOARD'],
    bgColor: '#1a2e1a',
    textColor: '#e2e8f0',
    accentColor: '#48bb78',
    icon: 'farm',
  ...
  },
  {
    id: 'sp-004',
    name: 'CyberVault',
    slot: 'RIGHT_RAIL_HALF_PAGE',
    enabled: true,
    size: 'standard',
    tagline: 'Data Security & Backup Solutions',
    websiteUrl: 'https://cybervault-demo.co.za',
    imageUrl: TEST_CREATIVE_URIS['RIGHT_RAIL_HALF_PAGE'],
    bgColor: '#1e1e2e',
    textColor: '#e2e8f0',
    accentColor: '#4299e1',
    icon: 'lock',
