  ...
  return (
    <footer className="site-footer">
      ...
      <div className="site-footer-right">
        <span className="site-footer-copy">© {new Date().getFullYear()} Alt Afrikaner Incident Tracker</span>
      ...
      <div className="modal-card disclaimer-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body disclaimer-body">
          <p className="disclaimer-lead">
            By accessing or using the Alt Afrikaner Incident Tracker (the &ldquo;Platform&rdquo;) you acknowledge that you have read,
